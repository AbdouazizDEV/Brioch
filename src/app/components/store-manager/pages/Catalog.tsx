...
import { 
  ...
  Download, TrendingUp, Layers, Package
} from "lucide-react";
...
export default function StoreManagerCatalog({ storeId }: { storeId: string }) {
  ...
  // Manager can manage categories for his store
    ...
    <div className="p-4 md:p-8 bg-[rgb(254,255,233)] min-h-[calc(100vh-80px)] space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Gérez l'offre, les prix et les stocks de votre boutique</p>
        </div>
      ...
      {activeTab === "products" ? (
              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-gray-50 text-gray-500 font-bold border-b border-gray-100 uppercase text-xs">
                  <tr>
                    ...
                    <th className="px-6 py-4">Prix Boutique</th>
        ...
        /* Categories View - Manager can manage categories */
      ...
      {/* Add/Edit Product Modal - Same as Admin but with store-specific pricing */}
      <AnimatePresence>
        {isModalOpen && (
          <ProductModal 
...
function ProductModal({ product, onClose, onSave, categories, storeId }: { product: any, onClose: () => void, onSave: (p: any) => void, categories: string[], storeId: string }) {
      ...
      >
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
          <div>
            ...
            <p className="text-xs text-gray-500">ID: {product?.id || "Nouveau"} • Boutique: Almadies</p>
          </div>
          ...
          {modalTab === "stock" && (
            <div className="space-y-4">
               <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-100 flex gap-3 text-sm text-yellow-800">
                  ...
                  <p>Vous pouvez personnaliser le prix et gérer le stock pour votre boutique uniquement.</p>
               </div>
               
               <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center justify-between mb-3">
                     <div className="flex items-center gap-2">
                        <span className="font-bold text-gray-900">Brioche Dorée Almadies</span>
                     </div>
