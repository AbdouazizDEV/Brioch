      ...
      <div className="bg-white rounded-xl shadow-bds-card border border-gray-100 overflow-hidden max-w-3xl">
         ...
         <div className="px-8 pb-8">
            <div className="relative -mt-12 mb-6">
              <div className="w-24 h-24 rounded-full border-4 border-white bg-bds-red text-white flex items-center justify-center font-bold text-3xl shadow-lg">A</div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-1">Administrateur Principal</h3>
                <p className="text-gray-500 text-sm mb-6">Superviseur Régional</p>
                
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-1">Email</label>
                    <p className="font-medium">admin@briochedoree.sn</p>
                  </div>
                  <div>
